...
把这个文件夹放进你的 Agent skills 目录，然后重启 Agent。

- Codex: `C:\Users\<你>\.codex\skills\resume-skill`
- Claude: `C:\Users\<你>\.claude\skills\resume-skill`
- 其他 Agent: 放到它支持的 skills/plugins 目录即可

第一次使用前，在 `resume-skill` 目录运行：
